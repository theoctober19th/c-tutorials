...
int main(){
    ...
    scanf("%s", username);
        ...
        __builtin___strcat_chk (home_path, "C:\\Users\\", __builtin_object_size (home_path, 2 > 1 ? 1 : 0));
        __builtin___strcat_chk (home_path, username, __builtin_object_size (home_path, 2 > 1 ? 1 : 0));
